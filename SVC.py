...
from sklearn.linear_model import LogisticRegression # not used in this case
from sklearn.metrics import accuracy_score, confusion_matrix
import seaborn as sns # used in debugging, may be helpful
...
for i in range(30000):
    ...
    clf = svm.SVC(kernel='rbf') # this is the default setting but makes this easier to read
